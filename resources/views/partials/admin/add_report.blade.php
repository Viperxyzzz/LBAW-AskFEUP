<div class="modal fade" id="add-report-modal-{{ $question->question_id}}-{{ $answer->answer_id ?? '' }}-{{ $comment->comment_id ?? '' }}" tabindex="-1" aria-labelledby="answerModalLabel" aria-hidden="true">
